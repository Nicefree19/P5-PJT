# FW:FW: (수정도면 공유) FW: [P5 복합동] 1층 Embedded Plate 도면(For Information) Issue

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2023-09-05 18:26:23
- **Source**: FW_FW_ (수정도면 공유) FW_ _P5 복합동_ 1층 Embedded Plate 도면(For Information) Issue (384).msg
