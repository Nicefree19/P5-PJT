# FW:P5 복합동 - 수조이동에 따른 PSRC 수정 시 영향성 정리 요청

- **From**: 이재용(JaeYong Lee) [이사] [설계팀]
- **Date**: 2025-09-05 15:50:01
- **Source**: FW_P5 복합동 - 수조이동에 따른 PSRC 수정 시 영향성 정리 요청.msg
...
**------ Original Message ------**  
**Date:** 2025-09-05 15:27:29  
**From:**강상규 < sk-.kang@samsung.com >  
**To:** 이재용(jaeyong lee) [이사] [설계팀] < jylee@senkuzo.com >  
**Cc:** 이동혁 [소장] [epc팀] < dhlee@senkuzo.com >,윤성환 < sh7752.youn@samsung.com >,위동표 < dp.wi@samsung.com >   
**Subject:** P5 복합동 - 수조이동에 따른 PSRC 수정 시 영향성 정리 요청
...
수조 이동에 따른 기 제작 PSRC의 수정에 대한 영향성을 정리하고자 메일을 보내드립니다.

첨부를 참고하시어 표에 작성 부탁드립니다.

수정 난이도는 시간과 돈을 포괄적으로 포함한다고 생각해 주시면 됩니다.

예를 들어 상인 경우에 상당히 수정에 많은 시간과 폐기 물량 등이 발생으로 수정 비용이 큼

급하게 보고 일정이 있어 월요일 오전까지는 회신 부탁드립니다.
