# FW:FW: P5 복합동 - PILE 반력 요청 (PILE 보강 여부 확인)

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2025-11-20 17:42:12
- **Source**: FW_FW_ P5 복합동 - PILE 반력 요청 (PILE 보강 여부 확인).msg
...
**------ Original Message ------**  
**Date:** 2025-11-20 17:38:37  
**From:**강상규 < sk-.kang@samsung.com >  
**To:**  
**Subject:** FW: P5 복합동 - PILE 반력 요청 (PILE 보강 여부 확인)
...
삼우에서 반력을 비교하기 위해 자료를 요청하였습니다.

해석 모델이 완료되면 아래의 반력 자료 부탁드립니다.
