# RE: Re:P5 복합동 - LOADING MAP 송부

- **From**: 윤성환
- **Date**: 2025-11-07 14:14:10
- **Source**: RE_ Re_P5 복합동 - LOADING MAP 송부 (2).msg

---

위동표 팀장님

T/C 관련 P6 골조시공시 좌대타입으로 반영되어야 할 구간과

좌대 크레인 반력이 필요합니다.

PSRC 기둥 설계에 반영하여야 하고, P6 4층 기둥 이음부 상세를 PSRC 기둥에 반영하기 위함입니다.

신우통해 해당되는 부위의 구조계산서와 좌대 프레임에 대한 인폼 요청드립니다.
...
Date : 2025-11-07 13:20 (GMT+9)

Title : Re:P5 복합동 - LOADING MAP 송부
...
회의에서 논의된 "하부 기초 보강이 없는 조건의 레이아웃" 확정과 그에 따른 일부 실 계획 레이아웃이 확정된 이후부터
