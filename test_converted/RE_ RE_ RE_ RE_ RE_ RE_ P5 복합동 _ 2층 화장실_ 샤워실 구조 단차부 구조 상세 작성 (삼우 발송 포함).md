# RE: RE: RE: RE: RE: RE: P5 복합동 _ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)

- **From**: 서성현
- **Date**: 2023-09-26 09:17:18
- **Source**: RE_ RE_ RE_ RE_ RE_ RE_ P5 복합동 _ 2층 화장실_ 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함).msg
...
첨부상세 전환설계도면 for 삼우설계 AFC R1.0에 포함시켜주세요. 
...
**Date**   : 2023-09-26 09:06 (GMT+9)

**Title**  : RE: RE: RE: RE: RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
유선상 말씀해주신 구간 수정 반영한 샤워실 단차상세 재송부 드리오니
