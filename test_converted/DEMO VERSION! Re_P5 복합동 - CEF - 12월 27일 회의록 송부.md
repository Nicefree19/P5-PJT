# DEMO VERSION! Re:P5 복합동 - CEF - 12월 27일 회의록 송부

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2025-01-02 16:41:50
- **Source**: DEMO VERSION! Re_P5 복합동 - CEF - 12월 27일 회의록 송부.msg
...
지난주 회의때 요청하셨던 현재까지 검토중인 관련 자료 정리해서 송부드립니다.
...
추가적으로 25년 1월 부터 계약에 따라서 보내드린 엑셀을 참조하시어 업무일지를 작성요청드립니다.

보내드린 파일은 시공 BIM 팀에서 작성한 파일입니다.

작업은 아래와 같이 진행 됩니다.

1. 일일작업일보는 매일 작성하여 메일로 전달 ( 엑셀 )

   - SECL -> SE&A 로 변경

   - 담당자 : 윤성환 LE

2. 근무현황은 월말 작성하여회신 바랍니다.

3. 프린트하여 날인후 제출은 기성전에 필요한 사항입니다.
