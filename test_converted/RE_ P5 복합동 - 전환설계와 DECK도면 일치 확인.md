# RE: P5 복합동 - 전환설계와 DECK도면 일치 확인

- **From**: endmall02
- **Date**: 2024-01-03 14:18:27
- **Source**: RE_ P5 복합동 - 전환설계와 DECK도면 일치 확인.msg
...
어제 강상규 프로님께서 주신 DECK 도면과 전환설계도면간 상이한 구간

체크하여 송부드리오니 첨부자료 확인 요청드립니다.
...
**Title** : P5 복합동 - 전환설계와 DECK도면 일치 확인
...
도면에서 전환설계 구조도면과 불일치 사항이 있는지 확인 부탁드립니다.
