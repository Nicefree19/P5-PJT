...
- **From**: 강상규
- **Date**: 2024-11-13 09:38:07
- **Source**: P5 복합동 뜬바닥 검토 (긴급 요청) (85).msg
...
삼우 설계 기준으로 최상층 기둥과 거더의 초과강도 계수를 반영해야 합니다.

하중조합에 지진하중 CASE에 3배 적용되었으니 참고 부탁드립니다.

1. 아래의 두개의 거더만 크기 검토 바랍니다.

   - RPG6e 부재와 RPG1e 거더

2. 건물 높이 관점에서 검토하는 것으로 최대한 DEPTH를 낮게 반영하는게 목표입니다.
