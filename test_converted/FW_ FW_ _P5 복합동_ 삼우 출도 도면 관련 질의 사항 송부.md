# FW: FW: [P5 복합동] 삼우 출도 도면 관련 질의 사항 송부

- **From**: senkuzo02
- **Date**: 2023-09-19 15:14:22
- **Source**: FW_ FW_ _P5 복합동_ 삼우 출도 도면 관련 질의 사항 송부.msg
...
**Date** : 2023-09-18 18:36 (GMT+9)

**Title** : FW: [P5 복합동] 삼우 출도 도면 관련 질의 사항 송부
...
구조도면을 확인 중 아래와 같이 오버브릿지를 받는 영역의 기둥마크가 서로 상의합니다.

기둥의 마크는 오버브릿지로 인하여 PC거더가 철골로 변경되는 곳에 따라서 정리하였습니다.

Grid 12와 51열의 기둥마크를 확인 부탁드립니다.

 

![](http://kr3.samsung.net/mail/rest/v1/files/image/download/%EC%A0%9C%EB%AA%A9+%EC%97%86%EB%8A%94+%EC%B2%A8%EB%B6%80+%ED%8C%8C%EC%9D%BC+124190_1.png?1=1&filepath=/SHARED/TEMP/ML/image/s/20230919/1_906_cafe_image_0@s-core.co.kr_1_sk-.kang&user=sk-.kang&partno=1&folderId=1&seqid=906&contentType=image%2Fpng)

![](http://kr3.samsung.net/mail/rest/v1/files/image/download/%EC%A0%9C%EB%AA%A9+%EC%97%86%EB%8A%94+%EC%B2%A8%EB%B6%80+%ED%8C%8C%EC%9D%BC+376108_0.png?1=1&filepath=/SHARED/TEMP/ML/image/s/20230919/1_906_cafe_image_1@s-core.co.kr_0_sk-.kang&user=sk-.kang&partno=0&folderId=1&seqid=906&contentType=image%2Fpng)
...
**Date** : 2023-09-18 17:27 (GMT+9)

**Title** : [P5 복합동] 삼우 출도 도면 관련 질의 사항 송부
