# DEMO VERSION! FW:RE: RE: RE: RE: RE: P5 복합동 _ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2023-09-26 08:46:25
- **Source**: DEMO VERSION! FW_RE_ RE_ RE_ RE_ RE_ P5 복합동 _ 2층 화장실_ 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함).msg
...
**Subject:** RE: RE: RE: RE: RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
작일 송부드린 2F 화장실 & 샤워실 단차 상세를 도면 1장으로 정리하여 재송부드리오니
...
**Date**   : 2023-09-25 17:25 (GMT+9)

**Title**  : RE: RE: RE: RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
**Date**   : 2023-09-25 16:33 (GMT+9)

**Title**  : RE: RE: RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
기 송부드린 2F 화장실 & 샤워실 단차 상세를 도면화 정리하여 재송부 드리오니
...
**Date**   : 2023-09-25 15:53 (GMT+9)

**Title**  : RE: RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
보내주신 상세는 공식이슈 할 수있도록 도면화 요청드립니다.
...
**Date**   : 2023-09-25 08:39 (GMT+9)

**Title**  : RE: P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
샤워실구간 -100 다운 영역 확장 반영된 

 

2층 단차 상세 송부드리오니 확인 요청드립니다.
...
**Date**   : 2023-09-23 10:11 (GMT+9)

**Title**  : P5 복합동 \_ 2층 화장실, 샤워실 구조 단차부 구조 상세 작성 (삼우 발송 포함)
...
삼우 AFC R1.0에 송부하기 위해서 2층 골조 단차부 상세를 작성요청드립니다.

작성된 도면은 삼우에 발송하여 별토 상세 추가예정입니다.
