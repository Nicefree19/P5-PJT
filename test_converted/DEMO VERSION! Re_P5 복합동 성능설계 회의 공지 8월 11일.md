# DEMO VERSION! Re:P5 복합동 성능설계 회의 공지 8월 11일

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2023-08-08 16:54:09
- **Source**: DEMO VERSION! Re_P5 복합동 성능설계 회의 공지 8월 11일.msg

---

| 대용량 첨부 (Big Attach ) **1개(files)** | |
| --- | --- |
| [230808\_P5 복합동 성능기반 설계업체 발신자료.zip](https://portal.senkuzo.com/rest/ml/mailAttachFile/bigDownload/6e34d0799d834be093eca68927e4f51e/2023080816540921196367EbBTm4vQAY "230808_P5 복합동 성능기반 설계업체 발신자료.zip") | (30 MB) | [Download](https://portal.senkuzo.com/rest/ml/mailAttachFile/bigDownload/6e34d0799d834be093eca68927e4f51e/2023080816540921196367EbBTm4vQAY) |
...
요청하신 한국방재에 송부한 자료와 자료내역 송부 드립니다.
...
| 2 | 230424 | 모델링 | REV20 |  |
| 3 | 230503 | 일람표 | REV20 |  |
| 4 | 230508 | 일람표 | REV20 | 1번의 오기수정 |
| 5 | 230609 | 일람표 및 모델링 | REV26 |  |
| 6 | 230614 | 모델링 | REV28 |  |
| 7 | 230628 | 일람표 및 모델링 | REV38 |  |
| \*위의 일람표는 공칭강도가 포함된 버전만 표기됨 | | | | |
...
**------ Original Message ------**  
**Date:** 2023-08-08 14:33:08  
**From:**강상규 < sk-.kang@samsung.com >  
**To:** 조남규 < nkcho@kdpt.co.kr >,정국기 < gkjeong@kdpt.co.kr >,이인호 [이사] [epc팀] < ihlee@senkuzo.com >,이동혁 [소장] < dhlee@senkuzo.com >,김대훈 < dhkim2630@naver.com >  
**Cc:** 서성현 < sunghyun.seo@samsung.com >,김준영 < jy0923.kim@samsung.com >   
**Subject:** P5 복합동 성능설계 회의 공지 8월 11일
...
아래의 안건에 대하여 회의 공지를 보내드립니다.

회의 일시 : 8월 11일 (금) 오전 8시 30분

회의 장소 : 평택설계사무실 - 접견실 1

회의 안건 : 1) 휨철근이 미 반영 사유에 대한 설명 ( 8월 10일(목) 회신 자료 )

               2) 전단 철근 반영 사유 설명

               3) 향후 예방 협의 ( 골조 변경점 발생으로 골조물량 감소 발생 시)
...
**Date** : 2023-08-08 09:32 (GMT+9)

**Title** : P5 복합동 부재 보강안 송부의 건

 

|  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 안녕하세요 프로님. 한국방재기술 정국기 과장입니다.    요청하셨던 보강안 정리하여 메일 드립니다.  PC보 거더의 경우 전단보강안 E&D몰과 협의하여 결정한 내용 첨부파일로 보내드리는 엑셀 첫번째 시트에 정리하였습니다.  PC보 보강 위치의 HMB 접합부의 경우에도 보강이 추가로 필요한지 검토 진행하였습니다. (해당 위치의 경우 보강을 하면서 재검토가 필요할 것으로 판단되어 기존 검토에서 접합부 검토가 되지 않았습니다.)  그 외에 상세 검토를 진행하던 중 HMB부재 전단강도가 PC보 부재보다 작게 설계된 위치의 경우 추가로 재검토하여  보강이 필요한 것으로 재검토 된 HMB부재들 추가로 정리하였고 쎈에 문의하여 해당 부재들도 같이 보강하기로 하였습니다.    HMB 접합부 보강안이 추가된 이유는 기존 검토시 HMB 접합부의 전단 강도가 PC보 보다 작게 나오는 위치는 저희 측에서 전달 상의 오류나 검토 엑셀 수식 상의 오류라고 생각하여  그런 위치의 경우 PC보 강도로만 검토를 우선 진행하였었는데, 이번에 재검토 진행하면서 쎈에 문의 후 설계된 HMB강도 그대로 반영하여 검토하게 되었습니다.    첨부파일 참조 부탁드립니다.    감사합니다.         |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | |  | |  | | --- | |  | | |  |  | | --- | --- | | |  | | --- | | 정국기 설계2소 / 과장  서울특별시 강남구 봉은사로 129, 201호 (논현동, 거평타운) Tel 213 Mobile +82 1093413663 Email [gkjeong@kdpt.co.kr](mailto:gkjeong@kdpt.co.kr) | | | | | | |
