# DEMO VERSION! FW:FW: [P5복합동] 삼성전자 보안서약서 작성 요청 (~8.19)

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: 2023-08-07 16:31:10
- **Source**: DEMO VERSION! FW_FW_ _P5복합동_ 삼성전자 보안서약서 작성 요청 (~8_19).msg
...
**------ Original Message ------**  
**Date:** 2023-08-07 16:09:14  
**From:**강상규 < sk-.kang@samsung.com >  
**To:** 이인호 [이사] [epc팀] < ihlee@senkuzo.com >,이동혁 [소장] [epc팀] < dhlee@senkuzo.com >,senkuzo01 < senkuzo.01@partner.samsung.com >,senkuzo02 < senkuzo.02@partner.samsung.com >,endmall01 < endmall.01@partner.samsung.com >,endmall02 < endmall.02@partner.samsung.com >,pstec < pstec@pstec-str.com >  
**Cc:** 서성현 < sunghyun.seo@samsung.com >,김준영 < jy0923.kim@samsung.com >   
**Subject:** FW: [P5복합동] 삼성전자 보안서약서 작성 요청 (~8.19)
...
P5 복합동 설계에 참여하시는 분들은 아래와 같이 보안서약서를 작성요청드립니다.

개인적인 일정으로 8월 14일 (월)까지 회신 부탁드립니다.
...
**Date** : 2023-08-07 13:20 (GMT+9)

**Title** : [P5복합동] 삼성전자 보안서약서 작성 요청 (~8.19)
...
전자 영업 1그룹으로부터 PJT 수행 전 인력에 대해 첨부 서명을 요청받아 작성 요청드립니다.

 

파일 내 작성 일자의 경우 실제 작성하시는 날짜를 기입하시면 되고, 인력마다 상이해도 상관 없습니다.

 

첨부#1. 보안서약서양식\_1차 협력사용 :  SECL 인원 작성

첨부#2. 보안서약서 명부\_2차 협력사용 : 각 협력사 별 명단 작성

첨부#3. 보안서약서양식\_2차 협력사용 : 각 협력사 전 인원 작성

 

산업설계팀 P5 복합동 인원 기준으로 도현민 프로님 (P3 복합동 LE) 과 이학섭 프로님 (환경설계팀) 은 수신인에서 제외하였으니 착오 없으시길 바랍니다.

 

발주처에 8월 21일까지 제출해야하므로 8월 19일 토요일 퇴근 전까지 회신 부탁드리겠습니다.
