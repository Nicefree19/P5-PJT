# FW:FW: (P5복합동) Ph1_ PIPE RACK 반력값 송부의 건

- **From**: 이인호 [이사] [EPC팀]
- **Date**: 2023-08-24 13:16:39
- **Source**: FW_FW_ (P5복합동) Ph1_ PIPE RACK 반력값 송부의 건 (587).msg
...
**------ Original Message ------**  
**Date:** 2023-08-24 13:10:34  
**From:**강상규 < sk-.kang@samsung.com >  
**To:** senkuzo01 < senkuzo.01@partner.samsung.com >,senkuzo02 < senkuzo.02@partner.samsung.com >,이인호 [이사] [epc팀] < ihlee@senkuzo.com >,endmall01 < endmall.01@partner.samsung.com >,endmall02 < endmall.02@partner.samsung.com >  
**Cc:** 서성현 < sunghyun.seo@samsung.com >,김준영 < jy0923.kim@samsung.com >   
**Subject:** FW: (P5복합동) Ph1\_ PIPE RACK 반력값 송부의 건
...
**Date** : 2023-08-16 19:12 (GMT+9)

**Title** : (P5복합동) Ph1\_ PIPE RACK 반력값 송부의 건
...
P5 복합동 \_Ph1 에 해당되는 각층(SECL Scope) 반력값을 첨부와 같이 정리하여 송부드리오니 업무에 참조하시기 바랍니다. 

(\*Ph1\_AFD 기준으로 작성, 대기방지 제외(Pallet Type 파이프렉 설치 예정)) 
