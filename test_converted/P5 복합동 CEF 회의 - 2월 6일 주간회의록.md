# P5 복합동 CEF 회의 - 2월 6일 주간회의록

- **From**: 강상규
- **Date**: 2025-02-07 13:25:12
- **Source**: P5 복합동 CEF 회의 - 2월 6일 주간회의록.msg
...
2월 6일 주간회의 내용 정리해 송부드립니다.

1. 부재 그룹핑 관련 내용 정리

  - 부재 선택 기준 내용 보완

      ( 하부층 부재를 선택하여 상부층 기둥 동일한 라인으로 결정 )

      ( 도면 반영을 위한 현실적인 기준 )

2. 고강도 강재 적용건 정리

   - 고강도 적용 가능 기둥의 선택 기준 추가 요청

   - 부재별로 물량 추가요청 (ex) L-150 부재의 물량이 XX TON )

   - 최소 물량이 안되어 적용 불가로 정리 예정

3. PLEG 설계  

   - 2월 21일기준 물량 산출 완료

\*\* PLEG 설계 일정이 급하여 PSRC의 부재 그룹핑, 재료 강도, 시공시 검토 결과는 

   PLEG 설계를 우선 진행 후 정리하여 회신부탁드립니다.

   금액 산출 일정에 따라 PLEG 설계 일정을 아래와 같이 보내드립니다. 

   - 2월 12일 PLEG 설계자료 회신 (1차) - 13일 회의자료 사전 송부 요청

     ( PC보 연결부 관련하여 빠르게 진행 할 수 있도록 적극적으로 진행 부탁드립니다. )

   - 2월 19일 설계 확정 (2차) 및 상세 관련 도면 정리 ( PSRC, HMB의 설계 변경 포함 )

   - 2월 21일 기준 물량 산출 완료 ( 공무팀 전달 )
