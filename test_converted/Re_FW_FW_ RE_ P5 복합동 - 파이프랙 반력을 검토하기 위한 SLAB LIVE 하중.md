# Re:FW:FW: RE: P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중

- **From**: 손근영 [과장] [EPC팀]
- **Date**: 2023-12-12 11:35:07
- **Source**: Re_FW_FW_ RE_ P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중.msg
...
**------ Original Message ------**  
**Date:** 2023-12-01 15:08:48  
**From:**이동혁 [소장] [EPC팀] < dhlee@senkuzo.com >  
**To:** 손근영 [과장] [EPC팀] < kyson@senkuzo.com >  
**Subject:** FW:FW: RE: P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중
...
**------ Original Message ------**  
**Date:** 2023-11-08 10:10:22  
**From:**강상규 < sk-.kang@samsung.com >  
**To:** endmall01 < endmall.01@partner.samsung.com >,endmall02 < endmall.02@partner.samsung.com >,senkuzo02 < senkuzo.02@partner.samsung.com >,이동혁 [소장] [epc팀] < dhlee@senkuzo.com >  
**Cc:** 서성현 < sunghyun.seo@samsung.com >   
**Subject:** FW: RE: P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중
...
아래의 장비 및 작업하중을 반영하여 보내드린는 파이프랙의 반력 검토 요청드립니다.

12F의 경우에 파이프랙의 영역만 하중을 변경하여 검토 요청드립니다.

아래의 하중으로 NG 발생시 연락 바랍니다.

 

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 층 | 실 | 설계 활하중     kN/m2 | **파이프랙 반력 검토   시****SLAB 활하중 (kN/m******2********)**** | 비고 |
| 8F | AIR COMP. | 15 | **3** |  |
| 10F | BOILER | 30 | **15** | 보일러   장비 사이에 반영됨     따라서 하중을 받는 거더의     보일러 영역 50% 반영 |
| 12F     (ROOF) | 수조 옆 PIPE RAK | 33 | **5** | 유지 보수시 최대 활하중 가정 |
...
**Date**   : 2023-11-06 20:40 (GMT+9)

**Title**  : RE: P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중
...
PIPERACK의 기둥 반력값은 첨부와 같이 일부 수정되었습니다. 

AFC 설계Inform  변경에 따른 일부값이 증가 되었습니다. 

대표적으로  8층 바닥과 12층(옥상) 바닥에 Reaction 값이 변경되었으니 참조하시기 바랍니다. 

 

파이프랙 설치 외의 구간에 대한 활하중 적용에 대해서는 

8층, 10층 : 장비배치(X-Plan 및 장비하중 check) 및 Maintenance(유지보수를 위한 동선, Lay-down등 Check) 를 고려하여 산정 필요 

12(옥상)층 : 파이프랙의 하부를 이야기 하는 거라면 제어 트레이 정도 설치될 것으로 보입니다. -  BIM 확인 필요 

 

내일 BIM을 한번 살펴 보고, 타공종 문의 후 판단하는게 좋을거 같습니다. 
...
**Date**   : 2023-11-06 18:48 (GMT+9)

**Title**  : P5 복합동 - 파이프랙 반력을 검토하기 위한 SLAB LIVE 하중
...
파이프랙의 반력을 골조에 반영하여 검토할 때 파이프랙을 제외한 SLAB 기본 활하중을 아래와 같이 정리하였습니다.

ROOF층의 경우에는 파이프랙 하중 영역에 장비등이 없어 작업하중을 500kg/m2을 반영하려고 합니다.

하중에 대하여 적절한지 의견부탁드립니다.
