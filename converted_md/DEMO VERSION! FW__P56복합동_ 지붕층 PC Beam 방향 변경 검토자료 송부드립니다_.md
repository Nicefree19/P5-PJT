# DEMO VERSION! FW:[P56복합동] 지붕층 PC Beam 방향 변경 검토자료 송부드립니다.

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: Unknown Date
- **Source**: DEMO VERSION! FW__P56복합동_ 지붕층 PC Beam 방향 변경 검토자료 송부드립니다_.msg
...
**Subject:** [P56복합동] 지붕층 PC Beam 방향 변경 검토자료 송부드립니다.
