# DEMO VERSION! FW:FW: [P5복합동] 구조 설계하중 송부 

- **From**: 이동혁 [소장] [EPC팀]
- **Date**: Unknown Date
- **Source**: DEMO VERSION! FW_FW_ _P5복합동_ 구조 설계하중 송부 .msg
...
**Date** : 2023-05-04 13:27 (GMT+9)

**Title** : [P5복합동] 구조 설계하중 송부
...
금일 회의결과 반영한 P5 복합동 설계하중 송부합니다.

 

설계하중관련 금일 변경사항 및 협의사항은 아래와 같습니다.

- Roof D/H부 층막이 고려 Dead Load 3.6kN/m2 추가

- Roof 냉각탑구간과 일반구간의 고정하중은 현재대로 분리하여 적용 

  (단, Roof P/R 반력 집중하중기준으로 PC Beam은 별도 검토)
