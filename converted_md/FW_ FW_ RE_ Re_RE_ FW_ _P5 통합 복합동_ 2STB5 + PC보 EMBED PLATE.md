# FW: FW: RE: Re:RE: FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE

- **From**: senkuzo02
- **Date**: Unknown Date
- **Source**: FW_ FW_ RE_ Re_RE_ FW_ _P5 통합 복합동_ 2STB5 + PC보 EMBED PLATE.msg
...
**Date** : 2023-09-15 09:48 (GMT+9)

**Title** : FW: RE: Re:RE: FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE
...
2층 복도의 EP위치는 아래와 같이 C to C기준 2450mm으로 반영 바랍니다.
...
**Date** : 2023-09-15 09:46 (GMT+9)

**Title** : RE: Re:RE: FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE
...
아래의 도면은 X-PLAN r1.2의 복도부분의 도면치수 입니다.

조수정 소장이 건축팀에 확인 했을 때 문제가 없을 것이라는 답변을 전달해 주셨습니다.

철골보의 위치는 C to C로 2450mm기준으로 PC보에 E.P를 반영하겠습니다.

![](http://kr3.samsung.net/mail/rest/v1/files/image/download/%EC%A0%9C%EB%AA%A9+%EC%97%86%EB%8A%94+%EC%B2%A8%EB%B6%80+%ED%8C%8C%EC%9D%BC+36028_1.png?1=1&filepath=/SHARED/TEMP/ML/image/s/20230915/1_892_cafe_image_2@s-core.co.kr_1_sk-.kang&user=sk-.kang&partno=1&folderId=1&seqid=892&contentType=image%2Fpng)
...
**Date** : 2023-09-15 09:35 (GMT+9)

**Title** : Re:RE: FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE

 

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 삼우구조 조수정 소장입니다.    건축에 확인한 결과, 2450을 적용하여도 문제가 없을것으로 보입니다.    업무에 참조하시기바랍니다.    ------------ 원본 메일 내용 ------------ **보낸 사람 :** "강상규"<sk-.kang@samsung.com> **받는 사람 :** "김형섭" <hyungsup.kim@samoo.com>  **참      조 :** "조수정" <samoocon04@samoo.co.kr>, "senkuzo01" <senkuzo.01@partner.samsung.com>, "senkuzo02" <senkuzo.02@partner.samsung.com>, "endmall01" <endmall.01@partner.samsung.com>, "endmall02" <endmall.02@partner.samsung.com>, "서성현" <sunghyun.seo@samsung.com>, "김준영" <jy0923.kim@samsung.com> ; **메일 제목 :** RE: FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE **보낸 날짜 :** 2023/09/15 09:08   |  |  |  |  | | --- | --- | --- | --- | | 수신 : 김형섭 마스터님    안녕하십니까   보내주신 복도의 EP의 평면상 위치확인 부탁드립니다.  AFD R0.1에 따라서 C to C로 2450mm위치에 반영하겠습니다.         감사합니다.  Best Regard.      강상규 프로 (SANG-KYOU KANG)  I & E Structural Eng’g Group  SAMSUNG ENGINEERING Co., LTD.  Office:  +82-2-2053-4872  Mobile: +82-10-4872-5730  e-mail: sk-.kang@samsung.com     **위 전자우편에 포함된 정보는 위에 기재된 수신인만을 위해 발송되는 것으로서**  **보안을 유지해야 하는 정보 및 법률상****또는 다른 사유로 인하여 공개가 금지된 정보가 들어 있을 수 있습니다.**  **귀하가 이 전자우편의 지정 수신인이 아니면 이를 무단으로 보유, 전송, 배포할 수 없으며,**  **일부의 내용이라도 공개,****복사해서는 안됩니다.**  **그러므로, 잘못 수신된 경우에는 즉시 전화 또는 전자우편 주소로 연락하여 주시고,**  **원본 및 사본과 그에 따른 첨부 문서를 모두 삭제하여 주시기 바랍니다.**  **Confidentiality Notice: This e-mail is intended for the addressee named in the above.**  **The information contained in this e-mail is confidential and privileged. If you are not the intended recipient,**  **you are hereby notified that any dissemination, distribution or copying ofthis communication is strictly prohibited.**  **If you have received this e-mail in error, please notify the sender immediately and destroy this e-mail message.**  **Thank you.**        --------- **Original Message** ---------  **Sender** : 김형섭 <hyungsup.kim@samoo.com> EM/마스터/하이테크3본부/삼우종합건축사사무소  **Date** : 2023-09-14 15:21 (GMT+9)  **Title** : FW: [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE     안녕하십니까?    2층 Core #11부분 복도쪽 빔의 E.P를 보내오니 업무에 참고하여 주시기 바랍니다.    감사합니다.       --------- **Original Message** ---------  **Sender** : 조수정 <samoocon04@samoo.co.kr>  **Date** : 2023-09-14 15:02 (GMT+09:00)  **Title** : [P5 통합 복합동] 2STB5 + PC보 EMBED PLATE      |  | | --- | | 삼우구조 조수정 소장입니다.    오늘오전에 업무회의에서 SECL이 요청했던    2STB5+PC보의 EMBEDPLATE 상세 송부합니다.    업무에 참조하시기 바랍니다. |         |  | | --- | | P Please consider the environment before printing this email |              |  | | --- | |  | | |
